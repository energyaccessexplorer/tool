...
build-a:
	...
	@cp ${SRC}/{browser,analysis,cards,config,controls,controls-search,geographies-search,vectors-search,analysis-search,locations-search,ds,parse,indexes,mapbox,overlord,plot,report,summary,timeline,views,a}.js ${DIST}/a/
